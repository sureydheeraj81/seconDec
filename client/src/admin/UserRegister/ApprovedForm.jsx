...
const ApprovedForm = () => {
    ...
    // const adminInfo = JSON.parse(token).id;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // const rejdata = reasons.find(item =>item.sno=== formData.rejected_reason)
        // formData.rejectDes=rejdata.description
        // console.log(rejdata);
...
//                 const response = await acceptedData(sno);
//                 const rejectionData = await getRegRejectionReason();
//                 console.log(rejectionData.data.data);
//                 setReason(rejectionData.data.data);
//                 setFormData(response.data.Data);
//             } catch (error) {
//                 toast.error("Error fetching user data:", error);
...
//             const response = await updateUser(isUpdate ? formData : {}, sno);
//             // const response = await updateUser(formData,sno);

//             if (response.data.success===true) {
//                 toast.success(response.data.message);
//                 navigate('/admin/dashboard');
//             } else {
//                 toast.error(response.data.message || "Error updating user.");
//             }
//         } catch (error) {
//             console.log(error);
//             toast.error("Error updating user:", error);
...
//         const rejdata = reasons.find(item => item.sno === formData.rejected_reason);
// // console.log(rejdata.description);
//         if (rejdata) {
//             formData.rejectDes = rejdata.description;
//         }
...
//     // if (formData.is_rejected === 'Rejected') {
//     //     const rejData = reasons.find(item => item.sno === formData.rejected_reason);
//     //     if (rejData) {
//     //         formData.rejectDes = rejData.description;
//     //     }
...
//                                     reasons.map((state, index) => (
//                                         <option key={index} value={state.description}>
//                                         {/* <option key={index} value={state.sno}> */}
