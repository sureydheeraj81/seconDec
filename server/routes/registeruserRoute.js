...
const{createRegistration,updateRegistration,rejectedData,approvedData,regionOneData,region2Data,pendingList,getSingleData,viewAllRegistrations,regionTransfer,regionOneGPA,dataChart,industryTypeCategoryCount}=require("../controllers/registrationController")
...
router.route("/chart-Data").get(dataChart)  
router.route("/industry-Data").get(industryTypeCategoryCount)   
